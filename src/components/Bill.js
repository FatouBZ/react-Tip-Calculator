  ...
  return (
    <div>
            ...
            <div className={classes.leftSide}>
                ...
                <p>Select Tip %</p>
                <div className={classes.tipSelection1}>
                    <button className={classes.tip} onClick={() => getPercentageAmount(0.05)}>5%</button>
                    <button className={classes.tip} onClick={() => getPercentageAmount(0.10)}>10%</button>
                    <button className={[classes.tip, classes.selectedTip].join(' ')} onClick={() => getPercentageAmount(0.15)}>15%</button>
                </div>
                
                <div className={classes.tipSelection2}>
                    <button className={classes.tip} onClick={() => getPercentageAmount(0.20)}>20%</button>
                    <button className={classes.tip} onClick={() => getPercentageAmount(0.25)}>25%</button>
                    <button type='submit' className={classes.tipCustom} onClick={() => getPercentageAmount(custom)}> <input onChange={handleCustom} value={custom} placeholder='Custom'/></button>
                </div>
                ...
                <input onChange={handleChangePerson} value={persons}/>
                </div>
            </div>

            <div className={classes.rightSide}>
                <div className={classes.tiPPerPerson}>
                    <div className={classes.tipDescription}>
                    <p className={classes.tipText}>Tip Amount</p>
                    <p>/Person</p>
                    </div>
                   
                    <p className={classes.tipDiscount}>{tipAmount / persons}</p>
                </div>
                <div className={classes.tiPPerPerson}>
                    <div className={classes.tipDescription}>
                    <p className={classes.tipText}>Total</p>
                    <p>/Person</p>
                    </div>
                
                    <p className={classes.priceTotal}>{tipAmount + (amount /persons)}</p>
                </div>

                <button type='submit' className={classes.ResetBtn} onClick={()=> {setAmount(initialAmount), setTipAmount(initialAmount), setPersons(1)}}>RESET</button>
            </div>
            </div>
    </div>
